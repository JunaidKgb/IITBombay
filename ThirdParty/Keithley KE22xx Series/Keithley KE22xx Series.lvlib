...
Keithley KE22xx Series Programmable DC Power Supply.</Property>
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="Operation Enable Register.vi" Type="VI" URL="../Public/Action-Status/Operation Enable Register.vi"/>
			<Item Name="Operation Sub Register.vi" Type="VI" URL="../Public/Action-Status/Operation Sub Register.vi"/>
			<Item Name="Query Status.vi" Type="VI" URL="../Public/Action-Status/Query Status.vi"/>
			<Item Name="Quest Enable Register.vi" Type="VI" URL="../Public/Action-Status/Quest Enable Register.vi"/>
			<Item Name="Quest Sub Register.vi" Type="VI" URL="../Public/Action-Status/Quest Sub Register.vi"/>
			...
			<Item Name="Set Channel Output Power State.vi" Type="VI" URL="../Public/Action-Status/Set Channel Output Power State.vi"/>
			<Item Name="Set Trigger Current Limit.vi" Type="VI" URL="../Public/Action-Status/Set Trigger Current Limit.vi"/>
			<Item Name="Set Trigger Voltage Level.vi" Type="VI" URL="../Public/Action-Status/Set Trigger Voltage Level.vi"/>
			<Item Name="Status Register.vi" Type="VI" URL="../Public/Action-Status/Status Register.vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			<Item Name="Configure.mnu" Type="Document" URL="../Public/Configure/Configure.mnu"/>
			<Item Name="Combine Channels.vi" Type="VI" URL="../Public/Configure/Combine Channels.vi"/>
			<Item Name="Configure Channel Enable.vi" Type="VI" URL="../Public/Configure/Configure Channel Enable.vi"/>
		...
		<Item Name="Data" Type="Folder">
			...
			<Item Name="Read Triggered Current Limit.vi" Type="VI" URL="../Public/Data/Read Triggered Current Limit.vi"/>
			<Item Name="Read Triggered Voltage Level.vi" Type="VI" URL="../Public/Data/Read Triggered Voltage Level.vi"/>
		</Item>
		<Item Name="Utility" Type="Folder">
			<Item Name="Utility.mnu" Type="Document" URL="../Public/Utility/Utility.mnu"/>
			<Item Name="Configure Output Timer.vi" Type="VI" URL="../Public/Utility/Configure Output Timer.vi"/>
	...
	<Item Name="Keithley KE22xx Series Readme.html" Type="Document" URL="../Keithley KE22xx Series Readme.html"/>
</Library>
